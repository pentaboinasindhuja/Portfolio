...
function Skills() {
  ...
  return (
    <div name="Skills" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
      ...
      <p className="mb-6 p-2">I am proficient in the following tech stack and have successfully completed projects using HTML, CSS, JavaScript, React, and Node.js.</p>
