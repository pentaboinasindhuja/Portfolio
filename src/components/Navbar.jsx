  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 shadow-md h-16 fixed top-0 left-0 right-0 z-50 bg-white">
      ...
      <div className="flex space-x-2">
        <img src={home} className="h-12 w-12 rounded-full" alt="" />
        <h1 className="text-bold font-xl cursor-pointer mt-4 hover:scale-105 duration-200 cursor-pointer">Sindhuja
        {/* Sindhuj<span className="text-green-500 text-2xl">a</span> */}
            {/* <p className="text-sm">Sindhuja</p> */}
        </h1>
      </div>
      {/* desktop navbar */}
      <div>
      ...
      <div className="bg-white">
        ...
        {
            navItems.map(({id,text})=>(
                <li className="hover:scale-105 duration-200 cursor-pointer text-semibold " key={id}>
                  <Link 
